...
class GlaucomaTrain(GlaucomaBase):
    def __init__(self, **kwargs):
        super().__init__(txt_file="/scratch/dr/GlaucomaUnsupervised/Data/CSVs_Train/Train_org/train_AE.csv", data_root='/scratch/y.nawar/glaucoma/',**kwargs)
        
class GlaucomaValidation(GlaucomaBase):
    def __init__(self,txt_file="/scratch/y.nawar/glaucoma/AirOGS/valid.csv" , data_root='/scratch/y.nawar/glaucoma/AirOGS/images/', flip_p=0., **kwargs):
