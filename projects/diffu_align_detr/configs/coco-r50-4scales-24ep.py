...
train.init_checkpoint = "../pretrained/r50_v2.pkl"

train.output_dir = "../exps/diffu_aligndetr_24ep_r50"


model.detr_type = "diffu_det"
...
dataloader.test.batch_size = 1 #32 4gpu
